...
class EpollA  : AbstractPoll{
    ...
    bool opEvent(Event event  , int fd, int op , int type)
	{
		...
		switch(type)
		{
			case AIOEventType.OP_ACCEPTED: mask = EPOLL_EVENTS.EPOLLIN; break;
			case AIOEventType.OP_READED:   mask =  EPOLL_EVENTS.EPOLLET | EPOLL_EVENTS.EPOLLIN; break;
			
			case AIOEventType.OP_CONNECTED:
			case AIOEventType.OP_WRITEED:  mask = EPOLL_EVENTS.EPOLLET | EPOLL_EVENTS.EPOLLOUT; break;
			
			case AIOEventType.OP_ERROR:	mask = EPOLL_EVENTS.EPOLLERR;	break;
